...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-box">
                                <form id="add_school" method="POST" action="<?php echo base_url(); ?>schools/addnew_school">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="school_name" id="school_name" class="form-control form-control-solid mb-3 mb-lg-0"/>
                                    </div><br/><br/>
                                    ...
                                    <div class="fv-row mt-10">
                                        ...
                                        <textarea id="school_location" name="school_location"></textarea>
    ...
    <script>
        $('#school_name,#school_location').keyup(function () {
        ...
        $(document).ready(function(){ 
            $('#add_school').validate({
                ...
                messages:{
                    ...
                    school_location:{
                        required:"<span style='color:red;'>Please enter school location here</span>" 
                    }
                }
            });
        });
